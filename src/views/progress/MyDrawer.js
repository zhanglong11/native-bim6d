...
import {Tag, WhiteSpace, DatePicker,Button} from '@ant-design/react-native';
...
export default class MyDrawer extends Component {
    ...
    setNew=(isNew)=>{
        ...
        let newStatus=isNew?status?[taskStatus,'0'].join(','):['0'].join(','):taskStatus.split(',').filter(s=>s!='0').join(',');
        this.setState({
