...
export default class DealTaskList extends Component {
    ...
    getData = (getQueryData) => {
        ...
        if (getQueryData)
            this.setState(state => ({queryData: {...state.queryData, ...getQueryData}}), () => {
                post(`${mobileHttp}${APP_URL}/app/schedule/task/startlist`, this.state.queryData).then(data => {
                                ...
                                <View style={styles.listWrapperLast}>
                                    ...
                                    <View style={styles.marginItem}>
                                        <View style={styles.progress}>
                                            <Progress percent={d.actualProgress}/>
                                        </View>
                                        <Text>{d.actualProgress}%</Text>
                                    </View>
